...
1. Explain the difference between `RDBMS` and `SQL`.
   rbdms is the system behind the structured data whereas sql stans for structured query language
1. Why do tables need a `primary key`?
   in order to be able to get referenced by others and for uniqueness
